    ...
    public String buildEmail(String token){
        ...
        return
                "<div style='background-color: #2C3E50; color: white;'>"+
                        ...
                        "<p>Please confirm your email to continue registration. Click this <a style='color: white;' href='https://huborange.up.railway.app/web/index.html?token="+token+"'>LINK</a></p>"+
